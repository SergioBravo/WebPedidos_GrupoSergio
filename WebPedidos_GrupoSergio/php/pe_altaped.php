       ...
       <?php
                ...
                if ($cantidadStock>=$cantidadProducto) { //si la cantidad en stock es mayor o igual que las unidades del producto que se han pedido, entonces se agrega el producto al carro.
                        if (!array_key_exists($codigoProducto, $carroCompra)) { //se comprueba si el código producto existe en el carro de la compra.
                            ...
                            //var_dump($carroCompra); //variable de control por pantalla.
                              ...
                              foreach ($carroCompra as $codigoProducto => $cantidad) {

                                $carroCompra[$codigoProducto]=$cantidadProducto+$cantidad; //Si el producto estaba en el carro previamente, se puede añadir también.
        ...
        <?php
            ...
            if (isset($_POST['comprar'])) { //Si se pulsa el botón de comprar:
              ...
              $numPedido = consultaValor($conexion, "SELECT MAX(orderNumber) FROM orderdetails");
            	...
            	$trans="0";
            	$url="";
            	$urlOK="http://localhost/WebPedidos_GrupoSergio/WebPedidos_GrupoSergio/php/pe_altaped.php";
            	$urlOKKO="http://localhost/WebPedidos_GrupoSergio/WebPedidos_GrupoSergio/php/pe_altaped.php";
                    ...
                    if (preg_match($expresionRegular, $checkNumber)) { //Si el checkNumber cumple el formato, entonces hay dos opciones: o que esté bien o que esté repetido.
                        ...
                        if ($seRepite) {
                          ...
                          <form name="frm" action="https://sis-t.redsys.es:25443/sis/realizarPago" method="POST" target="_blank">
                           <input hidden type="text" name="Ds_SignatureVersion" value="<?php echo $version; ?>"/></br>
                           <input hidden type="text" name="Ds_MerchantParameters" value="<?php echo $params; ?>"/></br>
